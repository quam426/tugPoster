...
\begin{description}
	...
	\item[\texttt{IPTHeaderColor}:] Changes the color of all block headers. Needs to be defined via \texttt{\bs{}definecolor}, see \Cref{lst:color}

	\item[\texttt{IPTInstituteColor}:] Changes the color of rectangle on the left banner. Needs to be defined via \texttt{\bs{}definecolor}, see \Cref{lst:color}. Not used if \texttt{IPTInstituteBanner} is set.
